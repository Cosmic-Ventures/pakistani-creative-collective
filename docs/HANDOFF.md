...
**Subscriptions**
- One membership, two billing options, presented as a single card with a monthly/yearly toggle: **$7.99/month** or **$80/year** (matching the two products in your Stripe account).
