/**
 * The sample renderings of every transactional email template, built with the
 * same builders `src/lib/email.ts` uses in production.
 *
...
export const samples: { name: string; subject: string; html: string }[] = [
  {
